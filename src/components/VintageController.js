...
import { getSVGCenter, outBack, inBack, inOutBack } from '../util'
        ...
        <div className="container">
            ...
            viewBox="0 0 550 550" xmlSpace="preserve">
                <style type="text/css">{
                    ...
                    ".vintage-controller-st0{fill:#FF5651;}"+
                    ".vintage-controller-st3{fill:#FFFFFF;}"+
                    ".vintage-controller-st4{fill:#FF4E51;}"+
                    ".vintage-controller-st5{fill:#FFFFFF;}"
                }</style>
                ...
                <g clipPath="url(#button-controller-clipPath)">
                    <g ref={controllerButton}>
                        <ellipse id="button-top" className="vintage-controller-st5" cx="114.6" cy="295.2" rx="37" ry="24.7"/>
                        <path id="button-side" d="M114.8,317.9c-20.4,0-37-11-37-24.7v60.5h74v-60.5C151.8,306.8,135.2,317.9,114.8,317.9z"/>
                        
                    </g>
                </g>
                <ellipse id="joy-stick-ring" cx="275" cy="316.4" rx="62.9" ry="38.3"/>
                ...
                <g ref={joyStick}>
                    <g clipPath="url(#shaft-controller-clipPath)">
                        <path ref={joyStickShaft} className="vintage-controller-st5" d="M301.4,99.7l0,204.3c0,5.2-3.1,9.9-7.8,12.1c-5.4,2.5-11.7,3.9-18.6,3.9
                        s-13.2-1.4-18.6-3.9c-4.7-2.2-7.8-6.9-7.8-12.1l0-204.3c0-1.8,1.4-3.2,3.2-3.2h46.3C299.9,96.5,301.4,98,301.4,99.7z"/>
                    </g>
